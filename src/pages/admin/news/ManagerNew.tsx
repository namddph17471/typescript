            ...
            <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
              <div className="lg:flex lg:items-center lg:justify-between">
                ...
                <div className="mt-5 flex lg:mt-0 lg:ml-4">
                  <NavLink to={`/admin/news/add`} className="sm:ml-3">
                  ...
                  <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                      <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        ...
                        { news && news.map((item:NewType,index:number)=>{
                           return <tr key={index +1 }>
                              ...
                              <Link to={`/admin/news/${item._id}/edit`} className="border font-medium text-base text-white m-2 p-2 rounded bg-indigo-600">Edit</Link>
                              </td>
                            </tr>
                      })}
                          </tbody>
