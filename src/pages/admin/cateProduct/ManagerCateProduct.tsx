...
import { getcateProduct, removecateProduct, selectCateProduct } from '../../../redux/cateproductSlice'
import { CateProductType } from '../../../types/cateProduct'

const MangerCateProduct = () => {
  const dispatch = useDispatch()
  const product = useSelector(selectCateProduct)
  useEffect(()=>{
            ...
            <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
              <div className="lg:flex lg:items-center lg:justify-between">
                ...
                <div className="mt-5 flex lg:mt-0 lg:ml-4">
                  <NavLink to={`/admin/cateProduct/add`} className="sm:ml-3">
...
export default MangerCateProduct